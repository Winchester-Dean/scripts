...
tgid="-1001645836726"  # ID чата для автобэкапа (Необходим доступ к сообщениям)
tg2id="-1001645836726" # ID чата диллерской группы для отправки ключей
admls="1347349700"	   # ID Админа
...
${Purple}|${Font_default}${Red}Разработчик:${Yellow} ᴀᴜꜰꜰ sᴇʀᴠɪᴄᴇ ${Purple}            ${Font_default}${Purple}|${Font_default}
${Purple}|${Font_default}${Red}Telegram:${Yellow} @Auff7Service ${Purple}            ${Font_default}${Purple}|${Font_default}
