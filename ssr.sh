...
${Purple}|${Font_default}${Red}Разработчик:${Yellow} Leon Grant ${Purple}            ${Font_default}${Purple}|${Font_default}
${Purple}|${Font_default}${Red}Telegram:${Yellow} @ddnsnet ${Purple}            ${Font_default}${Purple}|${Font_default}
