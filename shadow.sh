...
tgid="-1994889404"  # ID чата для автобэкапа (Необходим доступ к сообщениям)
tg2id="-1994889404" # ID чата диллерской группы для отправки ключей
admls="6540610395"	   # ID Админа
bot_api="1773323786:AAFdxQy8FyMEUAQyU30mzhFs45Pzw6406ro" # Токен бота 
...
${Purple}|${Font_default}${Red}Разработчик:${Yellow} @TKMHACKER @KSENON${Purple}            ${Font_default}${Purple}|${Font_default}
${Purple}|${Font_default}${Red}Telegram:${Yellow} @TKMHACKER (@SLM_NIO) ${Purple}            ${Font_default}${Purple}|${Font_default}
